# We don't need to import all libraries unless we know we're running the bot.
import argparse
...
parser.add_argument('--version', '-V', action = 'version', version = data['packageInfo']['VERSION'], help = "Prints the current version of the bot.")
