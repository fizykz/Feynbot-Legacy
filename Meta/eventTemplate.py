...
def process(bot): #needs to be named process.
...
async def event(bot):	#Needs to be named event, but is called by the same arguments that are passed to the Discord.py API reference.
	pass #Code here.
